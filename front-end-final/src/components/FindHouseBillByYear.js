...
class FindHouseBillByYear extends Component {
    constructor(props){
        super(props);
        autobind(this);
    ...
    searchBill() {
        const self = this;
        axios.get('http://localhost:3001/find-house-bill-by-year', {
          params: {
        ...
        >
          ...
          <Grid textAlign='center' style={{height:'100%',padding:'5em'}} verticalAlign='middle' >
            <Grid.Column style={{maxWidth: 450}}>
                <Header inverted as='h2' textAlign='center'>SEARCH HOUSE BILL BY YEAR</Header>
                <Form size='large'>
                <Segment stacked>
...
export default FindHouseBillByYear;